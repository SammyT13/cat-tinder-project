# This is mock data
    # We're setting an array, cats, and each cat is an object with attributes
    # keys are: name:, age:, enjoys:, image:
cats = [
  {
    name: 'Felix',
    age: 2,
...
# This is just Ruby code
    # .each iterates each cats' information has it was crated in the database
